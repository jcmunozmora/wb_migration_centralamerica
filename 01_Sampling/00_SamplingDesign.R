...
r2_values <- list(migration = 0.3, food_insecurity = 0.20, dietary_diversity = 0.30)
...
summary_table <- results_strata %>% filter(SampleSize %in% c(200,600,800,1000,1200,1400,1600,2000,2200)) %>% select(-Male_SampleSize)
